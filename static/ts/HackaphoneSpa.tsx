        ...
        <div class="form-signin">
          ...
          <div className="form-floating">
            <input
              ...
              type="text" className="form-control" id="floatingInput"  placeholder="1234" maxLength={4} />
      ...
      <div>
        ...
        <div className="fixed-bottom">
          <div class="d-flex justify-content-center align-items-center">
            ...
            <button className="btn-primary rounded-circle m-2 p-3 text-white shadow-sm border border-2 border-secondary" style="width: 10vh; height: 10vh;" data-bs-toggle="tooltip" data-bs-placement="top" title="Я - Радионяня">
            ...
            {/* <!-- кнопка отключенного звука --> */}
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" class="bi bi-volume-mute" viewBox="0 0 16 16" style="display: none;">
