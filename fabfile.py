...
BACKEND_IMAGE = (
    "docker.pkg.github.com/sanyapalmero/hackathon-2021-v2/hackathon-2021-v2-backend"
)
FRONTEND_IMAGE = (
    "docker.pkg.github.com/sanyapalmero/hackathon-2021-v2/hackathon-2021-v2-frontend"
)
